...
(global-set-key (kbd "H-k")            (simple-ilambda (kill-buffer (current-buffer))))
...
(global-set-key (kbd "H-.")            'buffer-trail-forward)
(global-set-key (kbd "H-,")            'buffer-trail-backward)
(global-set-key (kbd "H-/")            'buffer-trail-show-breadcrumbs)
(global-set-key (kbd "H-9")            'buffer-trail-add)
(global-set-key (kbd "H-0")            'buffer-trail-drop)
(global-set-key (kbd "H-=")            'buffer-trail-drag-forward)
(global-set-key (kbd "H--")            'buffer-trail-drag-backward)
(global-set-key (kbd "H->")            'buffer-trail-last)
(global-set-key (kbd "H-<")            'buffer-trail-first)
